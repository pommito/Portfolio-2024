...
export default function Home() {
  return (
    <main className="flex flex-col justify-end md:grid md:grid-rows-5 gap-6 h-[100dvh] w-full max-w-[1920px] sm:h-full 2xl:mx-auto">
      <section className="row-start-1 row-span-3  flex flex-col justify-end gap-6 sm:h-full">
        ...
        >
          <p className="text-balance leading-normal lg:w-1/2">
            I’m a 25 years old developer based in France who likes to work with React, Wordpress, and AstroJS. With a
      ...
      <section className="hidden sm:auto-rows-auto  sm:w-full sm:h-full sm:grid sm:grid-cols-4 sm:gap-6 sm:row-start-4 sm:row-span-2 sm:grid-rows-1">
